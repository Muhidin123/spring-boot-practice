...
import com.example.demo.PersonsDao;
...
//  @CrossOrigin(origins = {"http://localhost:3000", "http://localhost:8080"})
    ...
    public ArrayList<Object> persons() throws ClassNotFoundException, SQLException {
        return new ArrayList<>(PersonsDao.ConnectionToPersonsTable());
    }
    ...
    public Person createPerson(@RequestBody Person person) throws SQLException {
        PersonsDao.updateTablePersons(person.getFirstName(),  person.getLastName(), person.getAddress(), person.getAge());
        return person;
    }
}
